...
13 *Salmonella enterica* genome assemblies were sourced from NCBI RefSeq, originally generated by Fricke et al. (2011) as part of a comparative genomics study of 28 *S. enterica* isolates. Genomes were sequenced using whole-genome random shotgun Sanger sequencing on an Applied Biosystems 3730xl DNA analyzer at 10–12x coverage. Six genomes were sequenced to completion; the remainder are draft assemblies. Full sequencing and assembly details are described in the original publication.
...
- Gurevich A, et al. (2013) QUAST: quality assessment tool for genome assemblies. *Bioinformatics*
